...
typedef UT_array* hash27_array_p;
typedef UT_array* hash81_array_p;
typedef UT_array* hash243_array_p;
typedef UT_array* hash6561_array_p;
...
size_t hash_array_len(hash_array_p array);
void hash_array_free(hash_array_p array);
flex_trit_t* hash_array_at(hash_array_p array, size_t index);

bool empty_hash(flex_trit_t const* const hash, size_t len);
