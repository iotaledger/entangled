...
void test_concurrent_queue() {
  ...
  TEST_ASSERT_EQUAL_INT(queue->vtable->pop(NULL, &data),
                        CONCURRENT_QUEUE_NULL_SELF);
  TEST_ASSERT_EQUAL_INT(CQ_POP(queue, NULL), CONCURRENT_QUEUE_NULL_DATA);

  TEST_ASSERT_EQUAL_INT(CQ_PUSH(queue, 0), CONCURRENT_QUEUE_SUCCESS);
  TEST_ASSERT_EQUAL_INT(CQ_PUSH(queue, 1), CONCURRENT_QUEUE_SUCCESS);
  TEST_ASSERT_EQUAL_INT(CQ_PUSH(queue, 2), CONCURRENT_QUEUE_SUCCESS);
  TEST_ASSERT_EQUAL_INT(CQ_PUSH(queue, 3), CONCURRENT_QUEUE_SUCCESS);
  TEST_ASSERT_EQUAL_INT(CQ_PUSH(queue, 4), CONCURRENT_QUEUE_SUCCESS);
  ...
  TEST_ASSERT_EQUAL_INT(CQ_POP(queue, &data), CONCURRENT_QUEUE_SUCCESS);
