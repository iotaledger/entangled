...
static void mam_wots_test(void) {
  ...
  MAM_TRITS_DEF0(N, 18);
  MAM_TRITS_DEF0(pk, MAM_WOTS_PUBLIC_KEY_SIZE);
  MAM_TRITS_DEF0(recovered_pk, MAM_WOTS_PUBLIC_KEY_SIZE);
  MAM_TRITS_DEF0(H, MAM_WOTS_HASH_SIZE);
  MAM_TRITS_DEF0(sig, MAM_WOTS_SIGNATURE_SIZE);
  MAM_TRITS_DEF0(K, MAM_PRNG_SECRET_KEY_SIZE);
