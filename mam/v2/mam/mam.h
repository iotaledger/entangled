...
typedef struct mam_send_msg_context_s {
  ...
  spongos_t s[1];    /*!< Main Spongos interface to wrap PB3 messages. */
...
typedef struct mam_send_packet_context_s {
  spongos_t s[1]; /*!< Main Sponge interface */
  trint18_t ord;
...
typedef struct mam_recv_msg_context_s {
  mam_ialloc_t *ma;  /*!< Allocator. */
  spongos_t s[1];    /*!< Main Spongos interface */
  spongos_t fork[1]; /*!< Spongos interface for PB3 forks. */
  ...
  spongos_t ms[1]; /*!< Sponge interface used by MSS layer */
  spongos_t ws[1]; /*!< Sponge interface used by WOTS layer */
  spongos_t ns[1]; /*!< Sponge interface used by NTRU layer */
