...
typedef enum _err_t {
  ...
  err_internal_error,  // internal logic error, mam2 is broken
  err_not_implemented,
  ...
  err_mam2_channel_not_found,
  err_mam2_endpoint_not_found,
  err_mam2_version_not_supported,
  err_mam2_channel_not_trusted,
  err_mam2_endpoint_not_trusted,
  err_mam2_keyload_irrelevant,  // recipient can't detect suitable key in
                                // keyload
  err_mam2_keyload_overloaded,  // recipient detected multiple suitable keys in
                                // keyload
