...
void test_snapshot_conf() {
  ...
  flex_trits_to_trytes(sig_pubkey, HASH_LENGTH_TRYTE,
                       conf.snapshot_signature_pubkey, HASH_LENGTH_TRIT,
                       HASH_LENGTH_TRIT);
