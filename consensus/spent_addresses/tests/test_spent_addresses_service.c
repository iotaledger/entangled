...
static char *spent_addresses_test_db_path = "consensus/spent_addresses/tests/spent-addresses-test.db";
static char *spent_addresses_db_path = "consensus/spent_addresses/tests/spent-addresses.db";
static char *tangle_test_db_path = "consensus/spent_addresses/tests/tangle-test.db";
static char *tangle_db_path = "consensus/spent_addresses/tests/tangle.db";
