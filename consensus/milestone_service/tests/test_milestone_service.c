...
static char *test_db_path = "consensus/milestone_service/tests/test.db";
static char *ciri_db_path = "consensus/milestone_service/tests/ciri.db";
static char *snapshot_path = "consensus/milestone_service/tests/snapshot.txt";
static char *snapshot_conf_path = "consensus/milestone_service/tests/snapshot_conf.json";
