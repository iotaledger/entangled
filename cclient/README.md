...
The documentation can be generated using [Doxygen](http://www.doxygen.nl/).  
...
After building the documentation, you can open it in a web browser by going to `entangled/out/html/index.html`.
