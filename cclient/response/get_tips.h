...
static inline retcode_t get_tips_res_hashes_push(
    get_tips_res_t* res, flex_trit_t const* const hash) {
  return hash243_stack_push(&res->hashes, hash);
}
static inline void get_tips_res_hashes_pop(get_tips_res_t* res,
                                           flex_trit_t* const buf) {
