...
static void test_request(void) {
  ...
  serializer.vtable.add_neighbors_deserialize_request(
      &serializer, serializer_out->data, req);
...
static void test_response(void) {
  ...
  serializer.vtable.add_neighbors_serialize_response(&serializer, res,
                                                     serializer_out);
