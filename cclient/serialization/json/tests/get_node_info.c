...
static void test_request(void) {
  ...
  serializer.vtable.get_node_info_serialize_request(&serializer, serializer_out);
...
static void test_response(void) {
  ...
  serializer.vtable.get_node_info_deserialize_response(&serializer, json_text, node_info);
  ...
  TEST_ASSERT_EQUAL_MEMORY(hash, node_info->latest_milestone, FLEX_TRIT_SIZE_243);
  ...
  TEST_ASSERT_EQUAL_MEMORY(hash, node_info->latest_solid_subtangle_milestone, FLEX_TRIT_SIZE_243);
