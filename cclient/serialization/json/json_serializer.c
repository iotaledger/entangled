...
void json_find_transactions_serialize_request(
    const serializer* const s, const find_transaction_req_t* const obj,
    char* out) {}

void json_find_transactions_deserialize_request(const serializer* const s,
...
void json_get_balances_serialize_response(const serializer* const s,
...
size_t json_get_balances_serialize_response_get_size_(
    const serializer* const s, const get_balances_res_t* const toSerialize) {
  return 0;
}
...
void json_get_inclusion_state_serialize_response(
    const serializer* const s, const get_inclusion_state_res_t* const obj,
    char* out) {}
...
void json_get_neighbors_serialize_response(const serializer* const s,
...
size_t json_get_neighbors_serialize_response_get_size(
    const serializer* const s, const get_neighbors_res_t* const toSerialize) {
  return 0;
}
...
void json_get_node_info_serialize_response(const serializer* const s,
...
size_t json_get_node_info_serialize_response_get_size(
    const serializer* const s, const get_node_info_res_t* const toSerialize) {
  return 0;
}
...
// get_tips_response
void json_get_tips_serialize_response(const serializer* const s,
...
size_t json_get_tips_serialize_response_get_size(
    const serializer* const s, const get_tips_res_t* const toSerialize) {
  return 0;
}
