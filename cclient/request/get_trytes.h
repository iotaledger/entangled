...
static inline retcode_t get_trytes_req_hash_add(get_trytes_req_t* const req,
                                                flex_trit_t const* const hash) {
  return hash243_queue_push(&req->hashes, hash);
}

static inline flex_trit_t* get_trytes_req_hash_get(get_trytes_req_t* const req,
                                                   size_t index) {
