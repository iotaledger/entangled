...
static inline flex_trit_t* get_inclusion_state_req_hash_get(
    get_inclusion_state_req_t* const req, size_t index) {
...
static inline flex_trit_t* get_inclusion_state_req_tip_get(
    get_inclusion_state_req_t* const req, size_t index) {
