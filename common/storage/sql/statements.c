...
char *iota_statement_transaction_select_by_hash =
    ...
    "," TRANSACTION_COL_VALUE "," TRANSACTION_COL_OBSOLETE_TAG
    "," TRANSACTION_COL_TIMESTAMP "," TRANSACTION_COL_CURRENT_INDEX
    "," TRANSACTION_COL_LAST_INDEX "," TRANSACTION_COL_BUNDLE
    "," TRANSACTION_COL_TRUNK "," TRANSACTION_COL_BRANCH "," TRANSACTION_COL_TAG
    "," TRANSACTION_COL_ATTACHMENT_TIMESTAMP
    "," TRANSACTION_COL_ATTACHMENT_TIMESTAMP_LOWER
    "," TRANSACTION_COL_ATTACHMENT_TIMESTAMP_UPPER "," TRANSACTION_COL_NONCE
    "," TRANSACTION_COL_HASH " FROM " TRANSACTION_TABLE_NAME
...
char *iota_statement_transaction_select_meta_fields_by_hash =
    ...
    "," TRANSACTION_COL_CURRENT_INDEX "," TRANSACTION_COL_LAST_INDEX
    "," TRANSACTION_COL_BUNDLE "," TRANSACTION_COL_TRUNK
    "," TRANSACTION_COL_BRANCH "," TRANSACTION_COL_TAG "," TRANSACTION_COL_HASH
