...
extern retcode_t iota_stor_transaction_count(void const* const connection,
                                             size_t* const count);

extern retcode_t iota_stor_transaction_store(
    void const* const connection, iota_transaction_t const* const data_in);

extern retcode_t iota_stor_transaction_load(void const* const connection,
...
extern retcode_t iota_stor_transaction_exist(void const* const connection,
                                             transaction_field_t const field,
                                             flex_trit_t const* const key,
                                             bool* const exist);
...
extern retcode_t iota_stor_transaction_load_hashes(
    void const* const connection, transaction_field_t const field,
...
extern retcode_t iota_stor_transaction_find(void const* const connection,
...
extern retcode_t iota_stor_milestone_store(
    void const* const connection, iota_milestone_t const* const data_in);

extern retcode_t iota_stor_milestone_load(void const* const connection,
                                          flex_trit_t const* const hash,
                                          iota_stor_pack_t* const pack);

extern retcode_t iota_stor_milestone_load_first(void const* const connection,
                                                iota_stor_pack_t* const pack);

extern retcode_t iota_stor_milestone_load_last(void const* const connection,
                                               iota_stor_pack_t* const pack);

extern retcode_t iota_stor_milestone_load_next(void const* const connection,
                                               uint64_t const index,
                                               iota_stor_pack_t* const pack);

extern retcode_t iota_stor_milestone_exist(void const* const connection,
                                           flex_trit_t const* const hash,
                                           bool* const exist);
...
extern retcode_t iota_stor_state_delta_store(void const* const connection,
                                             uint64_t const index,
                                             state_delta_t const* const delta);

extern retcode_t iota_stor_state_delta_load(void const* const connection,
                                            uint64_t const index,
