...
IOTA_EXPORT char* iota_sign_address_gen(char const* const seed,
  ...
  memset_secure(subseed, HASH_LENGTH_TRIT * sizeof(trit_t), 0,
  ...
  memset_secure(key, key_length * sizeof(trit_t), 0,
                key_length * sizeof(trit_t));
