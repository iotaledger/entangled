...
const char* error_2_string(retcode_t err) {
  switch (err) {
    ...
    case RC_NODE_FAILED_REQUESTER_INIT:
    case RC_NODE_FAILED_REQUESTER_DESTROY:
    ...
    case RC_BROADCASTER_COMPONENT_NULL_STATE:
    case RC_BROADCASTER_COMPONENT_NULL_NODE:
    case RC_BROADCASTER_COMPONENT_FAILED_INIT_QUEUE:
    case RC_BROADCASTER_COMPONENT_FAILED_DESTROY_QUEUE:
    case RC_BROADCASTER_COMPONENT_FAILED_THREAD_SPAWN:
    case RC_BROADCASTER_COMPONENT_FAILED_THREAD_JOIN:
    case RC_BROADCASTER_COMPONENT_FAILED_ADD_QUEUE:
    case RC_BROADCASTER_COMPONENT_STILL_RUNNING:
    // Processor component module
    case RC_PROCESSOR_COMPONENT_NULL_STATE:
    case RC_PROCESSOR_COMPONENT_NULL_NODE:
    case RC_PROCESSOR_COMPONENT_NULL_PACKET:
    case RC_PROCESSOR_COMPONENT_NULL_NEIGHBOR:
    case RC_PROCESSOR_COMPONENT_NULL_TX:
    ...
    case RC_PROCESSOR_COMPONENT_FAILED_TX_PROCESSING:
    case RC_PROCESSOR_COMPONENT_FAILED_REQ_PROCESSING:
    ...
    case RC_REQUESTER_COMPONENT_NULL_NODE:
