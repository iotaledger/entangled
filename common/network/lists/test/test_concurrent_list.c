...
void test_list() {
  ...
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(NULL, 0), false);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 0), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 1), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 2), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 3), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 4), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 5), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 6), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 7), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 8), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 9), true);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 10), false);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 42), false);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, -1), false);

  TEST_ASSERT_EQUAL_INT(list->vtable->remove(NULL, 0),
                        CONCURRENT_LIST_NULL_SELF);
  TEST_ASSERT_EQUAL_INT(list->vtable->remove(list, 8), CONCURRENT_LIST_SUCCESS);
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 8), false);
  ...
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 9), false);
  ...
  TEST_ASSERT_EQUAL_INT(list->vtable->contain(list, 7), false);
