...
class FlexTritArray {
  class FlexTritArrayProxy {
   ...
   public:
    ...
    operator trit_t() const {
      return flex_trit_array_at(flex_trit_array.flex_trits_.data(), flex_trit_array.num_trits_, index);
    }
    FlexTritArrayProxy operator=(trit_t t) {
      flex_trit_array_set_at(flex_trit_array.flex_trits_.data(), flex_trit_array.num_trits_, index, t);
      return *this;
    }
  };
 ...
 public:
  ...
  static size_t sizeForTrits(size_t num_trits) {return flex_trits_num_for_trits(num_trits);};
  ...
  /// @param[in] num_trits - the number of trits encoded in the vector of flex_trits
  /// @return FlexTritArray
  FlexTritArray(const std::vector<flex_trit_t> flex_trits, size_t num_trits) : flex_trits_(flex_trits), num_trits_(num_trits) {};
  ...
  FlexTritArrayProxy operator[](const int i) { return FlexTritArrayProxy(*this, i); }
  ...
  size_t insert(FlexTritArray &flex_trit_array, size_t start);
