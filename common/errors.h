...
#define RC_MODULE_CONSENSUS_SNAPSHOT (0x0C << RC_SHIFT_MODULE)
...
enum retcode_t {
  ...
  RC_CORE_STILL_RUNNING = 0x12 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  ...
  RC_CCLIENT_UTLIST = 0x09 | RC_MODULE_CCLIENT | RC_SEVERITY_MAJOR,
  RC_CCLIENT_FLEX_TRITS = 0x0A | RC_MODULE_CCLIENT | RC_SEVERITY_MAJOR,
