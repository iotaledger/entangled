...
#define RC_MODULE_CW (0x0A << RC_MODULE_SHIFT)
#define RC_MODULE_EXIT_PROBABILITIES (0x0B << RC_MODULE_SHIFT)
#define RC_MODULE_SNAPSHOT (0x0D << RC_MODULE_SHIFT)
#define RC_MODULE_LEDGER_VALIDATOR (0x0E << RC_MODULE_SHIFT)
#define RC_MODULE_TIP_SELECTOR (0x0F << RC_MODULE_SHIFT)
#define RC_MODULE_TANGLE (0x10 << RC_MODULE_SHIFT)
...
#define RC_MODULE_CONF (0xA7 << RC_MODULE_SHIFT)
...
enum retcode_t {
  ...
  // Consensus CW Module
  RC_CW_FAILED_IN_DFS_FROM_DB = 0x02 | RC_MODULE_CW | RC_SEVERITY_MAJOR,
  RC_CW_FAILED_IN_LIGHT_DFS = 0x03 | RC_MODULE_CW | RC_SEVERITY_MAJOR,

  // Consensus Exit Probabilities Module
  RC_EXIT_PROBABILITIES_INVALID_ENTRYPOINT = 0x06 | RC_MODULE_EXIT_PROBABILITIES | RC_SEVERITY_MAJOR,
  RC_EXIT_PROBABILITIES_MISSING_RATING = 0x07 | RC_MODULE_EXIT_PROBABILITIES | RC_SEVERITY_MODERATE,
  ...
  RC_CONF_PARSER_ERROR = 0x05 | RC_MODULE_CONF | RC_SEVERITY_FATAL,
