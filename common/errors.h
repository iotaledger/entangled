...
#define RC_MODULE_LEDGER_VALIDATOR (0x0D << RC_SHIFT_MODULE)
#define RC_MODULE_CONSENSUS_TIP_SELECTOR (0x0E << RC_SHIFT_MODULE)
...
enum retcode_t {
  ...
  RC_UTILS_OOM = 0x03 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
