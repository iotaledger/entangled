...
#define RC_MODULE_CONF (0x0F << RC_SHIFT_MODULE)
...
enum retcode_t {
  ...
  // Conf Module
  RC_CONF_NULL_CONF = 0x01 | RC_MODULE_CONF | RC_SEVERITY_FATAL,
  RC_CONF_INVALID_ARGUMENTS = 0x02 | RC_MODULE_CONF | RC_SEVERITY_FATAL,
};
