...
#define RC_MODULE_UTILS (0xA0 << RC_SHIFT_MODULE)

#define RC_MODULE_BROADCASTER_COMPONENT (0xA1 << RC_SHIFT_MODULE)
#define RC_MODULE_PROCESSOR_COMPONENT (0xA2 << RC_SHIFT_MODULE)
#define RC_MODULE_RECEIVER_COMPONENT (0xA3 << RC_SHIFT_MODULE)
#define RC_MODULE_REQUESTER_COMPONENT (0xA4 << RC_SHIFT_MODULE)
#define RC_MODULE_RESPONDER_COMPONENT (0xA5 << RC_SHIFT_MODULE)
#define RC_MODULE_CIRI_CONF (0xA6 << RC_SHIFT_MODULE)
...
enum retcode_t {
  ...
  RC_CONSENSUS_EXIT_PROBABILITIES_INVALID_ENTRYPOINT = 0x06 | RC_MODULE_CONSENSUS_EXIT_PROBABILITIES | RC_SEVERITY_MAJOR,
