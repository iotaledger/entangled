...
#define RC_MODULE_CONSENSUS_MT (0x0B << RC_SHIFT_MODULE)
...
enum retcode_t {
  ...
  RC_CORE_FAILED_API_INIT = 0x07 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_API_START = 0x08 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_API_STOP = 0x09 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_API_DESTROY = 0x0A | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_DATABASE_DESTROY =
      0x0B | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_STILL_RUNNING = 0x0C | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_MILESTONE_TRACKER_INIT =
      0x0D | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_MILESTONE_TRACKER_START =
      0x0E | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_MILESTONE_TRACKER_STOP =
      0x0F | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_MILESTONE_TRACKER_DESTROY =
      0x10 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
