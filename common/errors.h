...
#define RC_MODULE_CONSENSUS_CW (0x09 << RC_SHIFT_MODULE)
#define RC_MODULE_CONSENSUS_EXIT_PROBABILITIES (0x0A << RC_SHIFT_MODULE)
#define RC_MODULE_CONSENSUS_SNAPSHOT (0x0B << RC_SHIFT_MODULE)

#define RC_MODULE_UTILS (0xA1 << RC_SHIFT_MODULE)

#define RC_MODULE_BROADCASTER_COMPONENT (0xA2 << RC_SHIFT_MODULE)
...
#define RC_MODULE_CIRI_API (0xA8 << RC_SHIFT_MODULE)
...
enum retcode_t {
  ...
  RC_CORE_FAILED_NODE_INIT = 0x04 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_NODE_START = 0x05 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_NODE_STOP = 0x06 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_NODE_DESTROY = 0x07 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_API_INIT = 0x08 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_API_START = 0x09 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_API_STOP = 0x0A | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_API_DESTROY = 0x0B | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_SNAPSHOT_INIT = 0x0C | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_SNAPSHOT_DESTROY =
      0x0D | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_STILL_RUNNING = 0x0E | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  ...
  // Conf Module
  RC_CIRI_API_NULL_SELF = 0x01 | RC_MODULE_CIRI_API | RC_SEVERITY_FATAL,
  RC_CIRI_API_FAILED_THREAD_SPAWN =
      0x02 | RC_MODULE_CIRI_API | RC_SEVERITY_FATAL,
  RC_CIRI_API_FAILED_THREAD_JOIN =
      0x03 | RC_MODULE_CIRI_API | RC_SEVERITY_MODERATE,
  RC_CIRI_API_STILL_RUNNING = 0x04 | RC_MODULE_CIRI_API | RC_SEVERITY_FATAL,

  // Snapshot Module
  RC_SNAPSHOT_NULL_SELF =
      0x01 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_FILE_NOT_FOUND =
      0x02 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INVALID_FILE =
      0x03 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INVALID_SUPPLY =
      0x04 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INCONSISTENT_SNAPSHOT =
      0x05 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_OOM = 0x06 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INCONSISTENT_PATCH =
      0x07 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MAJOR,
};
