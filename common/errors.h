...
#define RC_MODULE_CORE (0x03 << RC_MODULE_SHIFT)
#define RC_MODULE_NODE (0x04 << RC_MODULE_SHIFT)
#define RC_MODULE_NEIGHBOR (0x05 << RC_MODULE_SHIFT)
#define RC_MODULE_CCLIENT (0x06 << RC_MODULE_SHIFT)
#define RC_MODULE_CONSENSUS (0x07 << RC_MODULE_SHIFT)
#define RC_MODULE_CW (0x08 << RC_MODULE_SHIFT)
#define RC_MODULE_EXIT_PROBABILITIES (0x09 << RC_MODULE_SHIFT)
#define RC_MODULE_SNAPSHOT (0x0A << RC_MODULE_SHIFT)
#define RC_MODULE_LEDGER_VALIDATOR (0x0B << RC_MODULE_SHIFT)
#define RC_MODULE_TIP_SELECTOR (0x0C << RC_MODULE_SHIFT)
#define RC_MODULE_TANGLE (0x0D << RC_MODULE_SHIFT)
#define RC_MODULE_UTILS (0x0E << RC_MODULE_SHIFT)
#define RC_MODULE_BROADCASTER (0x0F << RC_MODULE_SHIFT)
#define RC_MODULE_PROCESSOR (0x10 << RC_MODULE_SHIFT)
#define RC_MODULE_CONF (0x11 << RC_MODULE_SHIFT)
#define RC_MODULE_API (0x12 << RC_MODULE_SHIFT)
#define RC_MODULE_GOSSIP (0x13 << RC_MODULE_SHIFT)
#define RC_MODULE_MAM (0x14 << RC_MODULE_SHIFT)
#define RC_MODULE_HELPERS (0x15 << RC_MODULE_SHIFT)
#define RC_MODULE_CRYPTO (0x16 << RC_MODULE_SHIFT)
