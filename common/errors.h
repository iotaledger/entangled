...
enum retcode_t {
  ...
  RC_PROCESSOR_FAILED_INIT_QUEUE =
      0x06 | RC_MODULE_PROCESSOR | RC_SEVERITY_FATAL,
  RC_PROCESSOR_FAILED_DESTROY_QUEUE =
      0x07 | RC_MODULE_PROCESSOR | RC_SEVERITY_MODERATE,
  RC_PROCESSOR_FAILED_ADD_QUEUE =
      0x0A | RC_MODULE_PROCESSOR | RC_SEVERITY_MINOR,
  RC_PROCESSOR_STILL_RUNNING = 0x0B | RC_MODULE_PROCESSOR | RC_SEVERITY_FATAL,
  RC_PROCESSOR_INVALID_TRANSACTION =
      0x0E | RC_MODULE_PROCESSOR | RC_SEVERITY_MODERATE,
  RC_PROCESSOR_OOM = 0x0F | RC_MODULE_PROCESSOR | RC_SEVERITY_MODERATE,
