...
enum retcode_t {
  ...
  RC_OK = 0,
          RC_STORAGE_OOM =
    0x01 | RC_MODULE_STORAGE | RC_SEVERITY_MAJOR,
  ...
  //Consensus module
  RC_CONSENSUS_NOT_IMPLEMENTED = 
      0x01 | RC_MODULE_CONSENSUS | RC_SEVERITY_MAJOR,
  ...
  RC_CONSENSUS_OOM =
      0x04 | RC_MODULE_CONSENSUS | RC_SEVERITY_MAJOR,
  RC_CONSENSUS_NULL_PTR =
      0x04 | RC_MODULE_CONSENSUS | RC_SEVERITY_FATAL,

  //Utils module
  RC_UTILS_FAILED_REMOVE_FILE = 
      0x01 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_FAILED_TO_COPY_FILE = 
      0x02 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
