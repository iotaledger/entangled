...
#define RC_MODULE_CONSENSUS_TANGLE (0x10 << RC_SHIFT_MODULE)
...
enum retcode_t {
  ...
  RC_UTILS_FAILED_OPEN_SRC_FILE = 0x10 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_FAILED_OPEN_CREATE_DST_FILE = 0x11 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_FAILED_CLOSE_FILE = 0x12 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_FILE_DOES_NOT_EXITS = 0x13 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  // Utils Socket
  ...
  RC_RECEIVER_COMPONENT_INVALID_PROCESSOR = 0x01 | RC_MODULE_RECEIVER_COMPONENT | RC_SEVERITY_FATAL,

  // Requester component module
  RC_REQUESTER_COMPONENT_FAILED_INIT_LIST = 0x01 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_FATAL,
  RC_REQUESTER_COMPONENT_FAILED_DESTROY_LIST = 0x02 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_MODERATE,
  RC_REQUESTER_COMPONENT_FAILED_ADD_LIST = 0x03 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_MINOR,
  RC_REQUESTER_COMPONENT_FAILED_REMOVE_LIST = 0x04 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_MINOR,
  ...
  RC_CIRI_CONF_FILE_NOT_FOUND = 0x04 | RC_MODULE_CIRI_CONF | RC_SEVERITY_FATAL,
  ...
  RC_SNAPSHOT_FAILED_JSON_PARSING = 0x09 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_SERVICE_NOT_ENOUGH_DEPTH = 0x10 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_SERVICE_MILESTONE_NOT_LOADED = 0x11 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_SERVICE_MILESTONE_NOT_SOLID = 0x12 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_SERVICE_MILESTONE_TOO_OLD = 0x13 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,

  RC_SNAPSHOT_METADATA_FAILED_DESERIALIZING = 0x16 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_METADATA_FAILED_SERIALIZING = 0x17 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_STATE_DELTA_FAILED_DESERIALIZING = 0x18 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_MISSING_MILESTONE_TRANSACTION = 0x19 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
