...
enum retcode_t {
  ...
  RC_PROCESSOR_FAILED_INIT_QUEUE =
      0x01 | RC_MODULE_PROCESSOR | RC_SEVERITY_FATAL,
  RC_PROCESSOR_FAILED_DESTROY_QUEUE =
      0x02 | RC_MODULE_PROCESSOR | RC_SEVERITY_MODERATE,
  RC_PROCESSOR_FAILED_ADD_QUEUE =
      0x03 | RC_MODULE_PROCESSOR | RC_SEVERITY_MINOR,
  RC_PROCESSOR_STILL_RUNNING = 0x04 | RC_MODULE_PROCESSOR | RC_SEVERITY_FATAL,
  RC_PROCESSOR_INVALID_TRANSACTION =
      0x05 | RC_MODULE_PROCESSOR | RC_SEVERITY_MODERATE,
  RC_PROCESSOR_INVALID_REQUEST =
      0x06 | RC_MODULE_PROCESSOR | RC_SEVERITY_MODERATE,
