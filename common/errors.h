...
#define RC_MODULE_SQLITE3 (0x04 << RC_MODULE_SHIFT)
#define RC_MODULE_CORE (0x05 << RC_MODULE_SHIFT)
#define RC_MODULE_NODE (0x06 << RC_MODULE_SHIFT)
#define RC_MODULE_NEIGHBOR (0x07 << RC_MODULE_SHIFT)
#define RC_MODULE_CCLIENT (0x08 << RC_MODULE_SHIFT)
#define RC_MODULE_CONSENSUS (0x09 << RC_MODULE_SHIFT)
#define RC_MODULE_CONSENSUS_CW (0x0A << RC_MODULE_SHIFT)
#define RC_MODULE_CONSENSUS_EXIT_PROBABILITIES (0x0B << RC_MODULE_SHIFT)
#define RC_MODULE_CONSENSUS_SNAPSHOT (0x0D << RC_MODULE_SHIFT)
#define RC_MODULE_LEDGER_VALIDATOR (0x0E << RC_MODULE_SHIFT)
#define RC_MODULE_CONSENSUS_TIP_SELECTOR (0x0F << RC_MODULE_SHIFT)
#define RC_MODULE_CONSENSUS_TANGLE (0x10 << RC_MODULE_SHIFT)
#define RC_MODULE_UTILS (0xA1 << RC_MODULE_SHIFT)
#define RC_MODULE_BROADCASTER (0xA2 << RC_MODULE_SHIFT)
#define RC_MODULE_PROCESSOR (0xA3 << RC_MODULE_SHIFT)
#define RC_MODULE_CIRI_CONF (0xA7 << RC_MODULE_SHIFT)
#define RC_MODULE_API (0xA8 << RC_MODULE_SHIFT)
#define RC_MODULE_GOSSIP (0xA9 << RC_MODULE_SHIFT)
#define RC_MODULE_MAM (0xB0 << RC_MODULE_SHIFT)
#define RC_MODULE_HELPERS (0xB1 << RC_MODULE_SHIFT)
#define RC_MODULE_CRYPTO (0xB2 << RC_MODULE_SHIFT)
...
enum retcode_t {
  ...
  RC_SQLITE3_NO_PATH_FOR_DB_SPECIFIED = 0x06 | RC_MODULE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_NOT_IMPLEMENTED = 0x07 | RC_MODULE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_BINDING = 0x0A | RC_MODULE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_PREPARED_STATEMENT = 0x0B | RC_MODULE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_FINALIZE = 0x0C | RC_MODULE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_STEP = 0x0D | RC_MODULE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_BEGIN = 0x0E | RC_MODULE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_END = 0x0F | RC_MODULE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_ROLLBACK = 0x10 | RC_MODULE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_CONFIG = 0x11 | RC_MODULE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_INITIALIZE = 0x12 | RC_MODULE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_SHUTDOWN = 0x13 | RC_MODULE_SQLITE3 | RC_SEVERITY_FATAL,
  ...
  // Snapshot Module
  RC_SNAPSHOT_FILE_NOT_FOUND = 0x01 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INVALID_FILE = 0x02 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INVALID_SUPPLY = 0x03 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INCONSISTENT_SNAPSHOT = 0x04 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INCONSISTENT_PATCH = 0x05 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MAJOR,
  RC_SNAPSHOT_BALANCE_NOT_FOUND = 0x06 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_INVALID_SIGNATURE = 0x07 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_FAILED_JSON_PARSING = 0x08 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  ...
  // Tangle Module
  RC_TANGLE_TAIL_NOT_FOUND = 0x01 | RC_MODULE_CONSENSUS_TANGLE | RC_SEVERITY_MODERATE,
  RC_TANGLE_NOT_A_TAIL = 0x02 | RC_MODULE_CONSENSUS_TANGLE | RC_SEVERITY_MODERATE,
  ...
  // Conf Module
  RC_CIRI_CONF_INVALID_ARGUMENT = 0x01 | RC_MODULE_CIRI_CONF | RC_SEVERITY_FATAL,
  RC_CIRI_CONF_MISSING_ARGUMENT = 0x02 | RC_MODULE_CIRI_CONF | RC_SEVERITY_FATAL,
  RC_CIRI_CONF_UNKNOWN_OPTION = 0x03 | RC_MODULE_CIRI_CONF | RC_SEVERITY_FATAL,
  RC_CIRI_CONF_PARSER_ERROR = 0x05 | RC_MODULE_CIRI_CONF | RC_SEVERITY_FATAL,
