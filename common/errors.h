...
#define RC_MODULE_GOSSIP (0x10 << RC_MODULE_SHIFT)
...
enum retcode_t {
  ...
  RC_UTILS_SOCKET_TLS_RNG = 0x08 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_CA = 0x09 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_CLIENT_PEM = 0x0A | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_CLIENT_PK = 0x0B | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_CONF = 0x0C | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_AUTHMODE = 0x0D | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_CLIENT_AUTH = 0x0E | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_HANDSHAKE = 0x0F | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_CONNECT = 0x10 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_RECV = 0x11 | RC_MODULE_UTILS | RC_SEVERITY_MINOR,
  RC_UTILS_SOCKET_SEND = 0x12 | RC_MODULE_UTILS | RC_SEVERITY_MINOR,
