...
enum retcode_t {
  ...
  // Perceptive node modue
  RC_PERCEPTIVE_NODE_STILL_RUNNING =
      0x01 | RC_MODULE_PERCEPTIVE_NODE | RC_SEVERITY_FATAL,
  RC_PERCEPTIVE_NODE_FAILED_INIT =
      0x02 | RC_MODULE_PERCEPTIVE_NODE | RC_SEVERITY_FATAL,
  RC_PERCEPTIVE_NODE_FAILED_START =
      0x03 | RC_MODULE_PERCEPTIVE_NODE | RC_SEVERITY_FATAL,
  RC_PERCEPTIVE_NODE_FAILED_STOP =
      0x04 | RC_MODULE_PERCEPTIVE_NODE | RC_SEVERITY_FATAL,
  RC_PERCEPTIVE_NODE_FAILED_DESTROY =
      0x05 | RC_MODULE_PERCEPTIVE_NODE | RC_SEVERITY_FATAL,
