...
#define RC_MODULE_STORAGE_SQL (0x03 << RC_MODULE_SHIFT)
#define RC_MODULE_STORAGE_SQLITE3 (0x04 << RC_MODULE_SHIFT)
...
#define RC_MODULE_CONSENSUS_MT (0x0C << RC_MODULE_SHIFT)
