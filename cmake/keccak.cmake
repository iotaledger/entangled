...
if (NOT __KECCAK_INCLUDED)
  ...
  set(keccak_cmake_dir ${EXTERNAL_BUILD_DIR}/keccak/src/keccak)
  ...
  add_dependencies(keccak keccak_download) 

  list(APPEND EXTERNAL_LINK_LIBS "${CMAKE_INSTALL_PREFIX}/lib/libkeccak.a")
