...
retcode_t iota_tangle_transaction_delete(tangle_t const *const tangle, hash243_set_t const hashes) {
  return iota_stor_transaction_delete(&tangle->connection, hashes);
}
