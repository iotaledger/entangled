...
static char* test_db_path = "ciri/consensus/tip_selection/entry_point_selector/tests/test.db";
static char* ciri_db_path = "ciri/consensus/tip_selection/entry_point_selector/tests/ciri.db";
